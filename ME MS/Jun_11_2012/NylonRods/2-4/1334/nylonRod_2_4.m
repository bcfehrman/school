...
amp = 1.0e-1; %scaling for transducer
...
title('Defect response for 148mm and 75mm nylon rods', 'FontSize', font_s, 'FontWeight', font_w)
...
%legend('Theoretical Defect Response (Initial Phase)', 'Experimental Defect Response (Initial Phase)', 'Theoretical Defect Response (TR Phase (I1))', 'Experimental Defect Response (TR Phase (I1))')
title({'Response at defect PZT on initial iteration for the nylon rods', 'of length 148mm and 75mm'}, 'FontSize', font_s, 'FontWeight', font_w)
...
%legend('Theoretical Defect Response (Initial Phase)', 'Experimental Defect Response (Initial Phase)', 'Theoretical Defect Response (TR Phase (I1))', 'Experimental Defect Response (TR Phase (I1))')
title({'Response at defect PZT on the 150th iteration for the nylon rods', 'of length 148mm and 75mm'}, 'FontSize', font_s, 'FontWeight', font_w)
...
%legend('Theoretical Defect Response (Initial Phase)', 'Experimental Defect Response (Initial Phase)', 'Theoretical Defect Response (TR Phase (I1))', 'Experimental Defect Response (TR Phase (I1))')
title({'The amplitude gain of the response seen at the defect on each', 'iteration for the 148mm and 75mm nylon rods'}, 'FontSize', font_s, 'FontWeight', font_w)
