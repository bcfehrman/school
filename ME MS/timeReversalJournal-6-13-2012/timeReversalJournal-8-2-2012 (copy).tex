...
{\includegraphics[width=9.7cm,height=5.75cm]{lsCompression.jpg}}
\subfigure[Right side compression mechanism ]
{\includegraphics[width=9.7cm,height=5.75cm]{rsCompression.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{self_healing_setup1.jpg}}
\subfigure[Closer View of Apparatus]
{\includegraphics[width=9.7cm,height=5.75cm]{self_healing_setup2.jpg}}
\end{subfigmatrix}
 %  \begin{center}
%   \begin{tabular}{c}
%   \includegraphics[height=5cm]{self_healing_setup1.jpg}
%   \includegraphics[height=5cm]{self_healing_setup2.jpg}
%
%   \end{tabular}
%   \end{center}
   \caption[all]
...
{\includegraphics[width=9.7cm,height=5.75cm]{tr_setup_3.jpg}}
\subfigure[Closer View of Apparatus]
{\includegraphics[width=9.7cm,height=5.75cm]{tr_setup_4.jpg}}
\end{subfigmatrix}
 %  \begin{center}
%   \begin{tabular}{c}
%   \includegraphics[height=5cm]{self_healing_setup1.jpg}
...
\begin{figure}
\begin{center}
{\includegraphics[width=9.7cm,height=5.75cm]{initialWave.jpg}}
 \caption[comp1]
%>>>> use \label inside caption to get Fig. number with \ref{}
   { \label{initialWave}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Ch0Read.jpg}}
\subfigure[PZT B Recorded Response]
{\includegraphics[width=9.7cm,height=5.75cm]{Ch1Read.jpg}}
\end{subfigmatrix}
 %  \begin{center}
%   \begin{tabular}{c}
%   \includegraphics[height=5cm]{self_healing_setup1.jpg}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Ch0RMS.jpg}}
\subfigure[PZT B Windowed RMS]
{\includegraphics[width=9.7cm,height=5.75cm]{Ch1RMS.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Ch0Chosen.jpg}}
\subfigure[PZT B Selected Window]
{\includegraphics[width=9.7cm,height=5.75cm]{Ch1Chosen.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Ch0Scaled.jpg}}
\subfigure[PZT B Centered, Scaled, Reversed Window]
{\includegraphics[width=9.7cm,height=5.75cm]{Ch1Scaled.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-1-2_Iter_th_exp.jpg}}
\subfigure[Theory vs Experiment, 579mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-1-3_Iter_th_exp.jpg}}
\subfigure[Theory vs Experiment, 437mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-2-3_Iter_th_exp.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{steel-1-2_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 579mm and 437mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{steel-1-2_Final.jpg}}
\subfigure[Defect Amplitude Gain, 579mm and 437mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-1-2_iterationVsGain.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{steel-1-3_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 579mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{steel-1-3_Final.jpg}}
\subfigure[Defect Amplitude Gain, 579mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-1-3_iterationVsGain.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{steel-2-3_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 437mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{steel-2-3_Final.jpg}}
\subfigure[Defect Amplitude Gain, 437mm and 428mm steel rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Steel-2-3_iterationVsGain.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-2-3_Iter_th_exp.jpg}}
\subfigure[Theory vs Experiment, 148mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-2-4_Iter_th_exp.jpg}}
\subfigure[Theory vs Experiment, 105mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-3-4_Iter_th_exp.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-2-3_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 148mm and 105mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-2-3_Final.jpg}}
\subfigure[Defect Amplitude Gain, 148mm and 105mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-2-3_iterationVsGain.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-2-4_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 148mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-2-4_Final.jpg}}
\subfigure[Defect Amplitude Gain, 148mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-2-4_iterationVsGain.jpg}}
\end{subfigmatrix}
...
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-3-4_Initial.jpg}}
\subfigure[Defect Response 150th Iteration, 105mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{nylon-3-4_Final.jpg}}
\subfigure[Defect Amplitude Gain, 105mm and 75mm nylon rods]
{\includegraphics[width=9.7cm,height=5.75cm]{Nylon-3-4_iterationVsGain.jpg}}
\end{subfigmatrix}
